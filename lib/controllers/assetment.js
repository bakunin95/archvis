...
module.exports = function( html, filters ) {
  ...
  if ( !html || typeof html !== "string" ) {
    throw new TypeError( "assetment can only be called with a string" );
  }
  ...
  var filters = merge( Object.preventExtensions( Object.create( null, {
    ...
    hyperlink: { value: false, enumerable: true, writable: true }
  })), filters );
  ...
  var config = Object.create( null, {
    ...
    hyperlink: {
      value: { selectors: { element: "a", resource: "href" } },
      enumerable: true
    }
  });
