...
exports.start = function (req,res){
			   ...
			   // console.log(jsFileList);
				_.each(files, function (currentPath) {
					...
					if(analyse != null){
						...
						console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
						complexityAnalysisClass.normalizeData(analyse);
	...
	normalizeData: function(analyse){
		console.log("-----------------------------------");
	...
	switch(req.params[0]) {
		case "xml":
		console.log("its xml");
			complexityAnalysisClass.getRelations(constants.WEBSITE,"xml");
		break;
		case "pdf":
			complexityAnalysisClass.getRelations(constants.WEBSITE,"pdf");
		break;
		default:
			complexityAnalysisClass.getRelations(constants.WEBSITE,"json");
	} 
};