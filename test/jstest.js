...
describe('JSTEST', function() {
	describe('Js files exist', function() {
		...
		nodeTest('Js files exist','website/jstest/function.js');
		nodeTest('Js files exist','website/jstest/jquery.js');	
	...
	describe('jquery.js element', function() {
		nodeTest('Function ajax','website/jstest/jquery.js::url');
		nodeTest('Function ajax','website/jstest/jquery.js::url2');
		nodeTest('Function get','website/jstest/ajax/test.html');
		nodeTest('Function get','website/jstest/ajax/test2.html');

		nodeTest('Function var get','website/jstest/example.php');
		nodeTest('Function var get','website/jstest/example2.php');

		nodeTest('Function post','website/jstest/demo_test_post.asp');
		nodeTest('Function post','website/jstest/demo_test_post2.asp');

		nodeTest('Function load','website/jstest/demo_test.txt');
